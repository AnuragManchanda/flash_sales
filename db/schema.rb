...
ActiveRecord::Schema.define(version: 20170328192056) do
  ...
  add_index "user_deals", ["deal_id"], name: "fk_rails_4f40141a86", using: :btree
  add_index "user_deals", ["user_id"], name: "fk_rails_d8dd23af82", using: :btree
